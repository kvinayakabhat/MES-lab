...
void title()
{
    ...
    glColor3f(1.0, 1.0, 1.0);
    drawstring(100, 400, "Project by");
    glColor3f(1.0, 0.0, 0.0);
    drawstring(100, 360, "Ananya Bhat-4CB20CS010");
    glColor3f(1.0, 0.0, 0.0);
    drawstring(100, 320, "K Vinayaka Bhat-4CB20CS039");
    glColor3f(0.2, 0.3, 0.5);
    drawstring(100, 280, "VI CSE A");
    glColor3f(0.4, 0.4, 0.4);
    drawstring(100, 240, "Canara Engineering College");
    glColor3f(1.0, 1.0, 1.0);
